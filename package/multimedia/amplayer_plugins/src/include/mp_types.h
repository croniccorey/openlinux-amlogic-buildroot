...
typedef enum{
    ...
    MP_STATE_NOTIFYMSG,//just for notification,can be droped by high level.normally,has message code.
}MP_PlayBackState;
...
#define TITLE_LEN_MAX   256
#define ALBUM_LEN_MAX   128
#define AUTHOR_LEN_MAX 64

typedef struct{
    char title[TITLE_LEN_MAX];
    char album[ALBUM_LEN_MAX];
    char author[AUTHOR_LEN_MAX];
}MP_AudioTagInfo;
